<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CambioContrasena.aspx.cs" Inherits="Login_CambioContraseña" %>
...
<body>
    <form id="form1" runat="server">
        <div class="text-center" style="margin-right: auto; margin-left:auto; width: 400px;border: 3px solid #9D00AE;font-size: 10px;; background-color: white; box-shadow: 0px 0px 69px -4px rgba(169,173,185,1); height: 450px; margin-top: 50px;">
