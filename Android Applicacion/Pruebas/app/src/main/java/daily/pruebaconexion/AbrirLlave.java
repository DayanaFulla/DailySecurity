...
public class AbrirLlave extends AppCompatActivity {
                        ...
                        if(byteCount > 0)
                        {
                            ...
                            handler.post(new Runnable()
                            {
                                public void run()
                                {
                                    if(string.equals("3"))
                                    {
                                        Toast.makeText(AbrirLlave.this, "Bloqueado", Toast.LENGTH_LONG).show();
                                    }
                                    else if(string.equals("4"))
                                    {
                                        Toast.makeText(AbrirLlave.this, "Desbloqueado", Toast.LENGTH_LONG).show();
                                    }
                                }
                            });
                        }
