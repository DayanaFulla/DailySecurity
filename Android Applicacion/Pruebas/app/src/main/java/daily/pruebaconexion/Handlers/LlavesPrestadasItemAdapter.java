...
public class LlavesPrestadasItemAdapter extends LinearLayout{
    private TextView txtNombreLlave,txtActive, txtKeyID;

    public LlavesPrestadasItemAdapter(Context context, Llave llave) {
        super(context);
        ...
        txtNombreLlave.setText(llave.getNick());
